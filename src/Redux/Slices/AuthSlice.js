...
export const createAccount = createAsyncThunk('/auth/createAccount', async (data)=>{
    //data is the payload containing information to signup an user(email,firstName,mobileNumber,password,lastName)
...
const AuthSlice = createSlice({
    ...
    initialState,
    reducers:{},
    extraReducers : (builder) => { //builder object is passed by Redux
